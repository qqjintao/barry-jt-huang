...
public class DictUtils {
     ...
     *
     * @param key       参数键
     * @param dictDates 字典数据列表
     */
    public static void setDictCache(String key, List<SysDictDataDTO> dictDates) {
        SpringUtils.getBean(RedisCache.class).setCacheObject(getCacheKey(key), dictDates);
    }
